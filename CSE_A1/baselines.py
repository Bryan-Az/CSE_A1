...
import os
print(os.getcwd())
for user,recipe,d in readCSV("./a1_data/trainInteractions.csv.gz"):
  r = int(d['rating'])
  allRatings.append(r)
...
predictions = open("./a1_data/predictions_Rated.txt", 'w')
for l in open("./a1_data/stub_Rated.txt"):
...
for user,recipe,_ in readCSV("./a1_data/trainInteractions.csv.gz"):
...
predictions = open("./a1_data/predictions_Made.txt", 'w')
for l in open("./a1_data/stub_Made.txt"):
  if l.startswith("user_id"):
    #header
    predictions.write(l)
    continue
...
for d in readGz("./a1_data/trainRecipes.json.gz"):
